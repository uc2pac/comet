...
import * as import9 from './detail.component.ngfactory';
import * as import10 from '@angular/core/src/i18n/tokens';
import * as import11 from '../../../../src/app/+detail/detail.component';
...
class DetailModuleInjector extends import0.NgModuleInjector<import1.DetailModule> {
  ...
  constructor(parent:import8.Injector) {
    super(parent,[import9.DetailComponentNgFactory],([] as any[]));
  }
  ...
  get _ROUTES_7():any[] {
        if ((this.__ROUTES_7 == null)) { (this.__ROUTES_7 = [[{
          ...
          children: [
            {
              path: '',
              component: import11.DetailComponent
            }
            ,
            {
              path: 'child-detail',
